...
void LBM_performStreamCollide( LBM_Grid srcGrid, LBM_Grid dstGrid, const int x0, const int x1, const int y0, const int y1, const int z0, const int z1);
void LBM_handleInOutFlow( LBM_Grid srcGrid, const int x0, const int x1, const int y0, const int y1, const int z0, const int z1);
