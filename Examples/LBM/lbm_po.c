...
void PO_handleInOutFlow(PoCellEntry* poSrcGrid)
{
    MY_TYPE ux , uy , uz , rho , ux1, uy1, uz1, rho1, ux2, uy2, uz2, rho2, u2, px, py;
    ...
    for (z= 0; z < SIZE_Z; z++)
    {
        ...
        { /* inflow */        
            for (y = 0; y < SIZE_Y; y++)
            {
                for (x = 0; x < SIZE_X; x++)
                {
                    rho1 = + poSrcGrid[PO_INDEX(x, y, z+1)]._C  + poSrcGrid[PO_INDEX(x, y, z+1)]._N
                           + poSrcGrid[PO_INDEX(x, y, z+1)]._S  + poSrcGrid[PO_INDEX(x, y, z+1)]._E
                           + poSrcGrid[PO_INDEX(x, y, z+1)]._W  + poSrcGrid[PO_INDEX(x, y, z+1)]._T
                           + poSrcGrid[PO_INDEX(x, y, z+1)]._B  + poSrcGrid[PO_INDEX(x, y, z+1)]._NE
                           + poSrcGrid[PO_INDEX(x, y, z+1)]._NW + poSrcGrid[PO_INDEX(x, y, z+1)]._SE
                           + poSrcGrid[PO_INDEX(x, y, z+1)]._SW + poSrcGrid[PO_INDEX(x, y, z+1)]._NT
                           + poSrcGrid[PO_INDEX(x, y, z+1)]._NB + poSrcGrid[PO_INDEX(x, y, z+1)]._ST
                           + poSrcGrid[PO_INDEX(x, y, z+1)]._SB + poSrcGrid[PO_INDEX(x, y, z+1)]._ET
                           + poSrcGrid[PO_INDEX(x, y, z+1)]._EB + poSrcGrid[PO_INDEX(x, y, z+1)]._WT
                           + poSrcGrid[PO_INDEX(x, y, z+1)]._WB;

                    rho2 = + poSrcGrid[PO_INDEX(x, y, z+2)]._C  + poSrcGrid[PO_INDEX(x, y, z+2)]._N
                           + poSrcGrid[PO_INDEX(x, y, z+2)]._S  + poSrcGrid[PO_INDEX(x, y, z+2)]._E
                           + poSrcGrid[PO_INDEX(x, y, z+2)]._W  + poSrcGrid[PO_INDEX(x, y, z+2)]._T
                           + poSrcGrid[PO_INDEX(x, y, z+2)]._B  + poSrcGrid[PO_INDEX(x, y, z+2)]._NE
                           + poSrcGrid[PO_INDEX(x, y, z+2)]._NW + poSrcGrid[PO_INDEX(x, y, z+2)]._SE
                           + poSrcGrid[PO_INDEX(x, y, z+2)]._SW + poSrcGrid[PO_INDEX(x, y, z+2)]._NT
                           + poSrcGrid[PO_INDEX(x, y, z+2)]._NB + poSrcGrid[PO_INDEX(x, y, z+2)]._ST
                           + poSrcGrid[PO_INDEX(x, y, z+2)]._SB + poSrcGrid[PO_INDEX(x, y, z+2)]._ET
                           + poSrcGrid[PO_INDEX(x, y, z+2)]._EB + poSrcGrid[PO_INDEX(x, y, z+2)]._WT
                           + poSrcGrid[PO_INDEX(x, y, z+2)]._WB;
                    ...
                    PO_SRC_C (poSrcGrid) = DFL1*rho*(1.0                                 - u2);

                    PO_SRC_N (poSrcGrid) = DFL2*rho*(1.0 +       uy*(4.5*uy       + 3.0) - u2);
                    PO_SRC_S (poSrcGrid) = DFL2*rho*(1.0 +       uy*(4.5*uy       - 3.0) - u2);
                    PO_SRC_E (poSrcGrid) = DFL2*rho*(1.0 +       ux*(4.5*ux       + 3.0) - u2);
                    PO_SRC_W (poSrcGrid) = DFL2*rho*(1.0 +       ux*(4.5*ux       - 3.0) - u2);
                    PO_SRC_T (poSrcGrid) = DFL2*rho*(1.0 +       uz*(4.5*uz       + 3.0) - u2);
                    PO_SRC_B (poSrcGrid) = DFL2*rho*(1.0 +       uz*(4.5*uz       - 3.0) - u2);

                    PO_SRC_NE(poSrcGrid) = DFL3*rho*(1.0 + (+ux+uy)*(4.5*(+ux+uy) + 3.0) - u2);
                    PO_SRC_NW(poSrcGrid) = DFL3*rho*(1.0 + (-ux+uy)*(4.5*(-ux+uy) + 3.0) - u2);
                    PO_SRC_SE(poSrcGrid) = DFL3*rho*(1.0 + (+ux-uy)*(4.5*(+ux-uy) + 3.0) - u2);
                    PO_SRC_SW(poSrcGrid) = DFL3*rho*(1.0 + (-ux-uy)*(4.5*(-ux-uy) + 3.0) - u2);
                    PO_SRC_NT(poSrcGrid) = DFL3*rho*(1.0 + (+uy+uz)*(4.5*(+uy+uz) + 3.0) - u2);
                    PO_SRC_NB(poSrcGrid) = DFL3*rho*(1.0 + (+uy-uz)*(4.5*(+uy-uz) + 3.0) - u2);
                    PO_SRC_ST(poSrcGrid) = DFL3*rho*(1.0 + (-uy+uz)*(4.5*(-uy+uz) + 3.0) - u2);
                    PO_SRC_SB(poSrcGrid) = DFL3*rho*(1.0 + (-uy-uz)*(4.5*(-uy-uz) + 3.0) - u2);
                    PO_SRC_ET(poSrcGrid) = DFL3*rho*(1.0 + (+ux+uz)*(4.5*(+ux+uz) + 3.0) - u2);
                    PO_SRC_EB(poSrcGrid) = DFL3*rho*(1.0 + (+ux-uz)*(4.5*(+ux-uz) + 3.0) - u2);
                    PO_SRC_WT(poSrcGrid) = DFL3*rho*(1.0 + (-ux+uz)*(4.5*(-ux+uz) + 3.0) - u2);
                    PO_SRC_WB(poSrcGrid) = DFL3*rho*(1.0 + (-ux-uz)*(4.5*(-ux-uz) + 3.0) - u2);
                } /* for x */                
            } /* for y */
        } /* if (z==0) */
        ...
        {     /* outflow */
            for (y = 0; y < SIZE_Y; y++)
            {
                for (x = 0; x < SIZE_X; x++)
                {
                    ...
                    ux1 = + poSrcGrid[PO_INDEX(x, y, z-1)]._E  - poSrcGrid[PO_INDEX(x, y, z-1)]._W
                          + poSrcGrid[PO_INDEX(x, y, z-1)]._NE - poSrcGrid[PO_INDEX(x, y, z-1)]._NW
                          + poSrcGrid[PO_INDEX(x, y, z-1)]._SE - poSrcGrid[PO_INDEX(x, y, z-1)]._SW
                          + poSrcGrid[PO_INDEX(x, y, z-1)]._ET + poSrcGrid[PO_INDEX(x, y, z-1)]._EB
                          - poSrcGrid[PO_INDEX(x, y, z-1)]._WT - poSrcGrid[PO_INDEX(x, y, z-1)]._WB;
                    
                    uy1 = + poSrcGrid[PO_INDEX(x, y, z-1)]._N  - poSrcGrid[PO_INDEX(x, y, z-1)]._S
                          + poSrcGrid[PO_INDEX(x, y, z-1)]._NE + poSrcGrid[PO_INDEX(x, y, z-1)]._NW
                          - poSrcGrid[PO_INDEX(x, y, z-1)]._SE - poSrcGrid[PO_INDEX(x, y, z-1)]._SW
                          + poSrcGrid[PO_INDEX(x, y, z-1)]._NT + poSrcGrid[PO_INDEX(x, y, z-1)]._NB
                          - poSrcGrid[PO_INDEX(x, y, z-1)]._ST - poSrcGrid[PO_INDEX(x, y, z-1)]._SB;
                    
                    uz1 = + poSrcGrid[PO_INDEX(x, y, z-1)]._T  - poSrcGrid[PO_INDEX(x, y, z-1)]._B
                          + poSrcGrid[PO_INDEX(x, y, z-1)]._NT - poSrcGrid[PO_INDEX(x, y, z-1)]._NB
                          + poSrcGrid[PO_INDEX(x, y, z-1)]._ST - poSrcGrid[PO_INDEX(x, y, z-1)]._SB
                          + poSrcGrid[PO_INDEX(x, y, z-1)]._ET - poSrcGrid[PO_INDEX(x, y, z-1)]._EB
                          + poSrcGrid[PO_INDEX(x, y, z-1)]._WT - poSrcGrid[PO_INDEX(x, y, z-1)]._WB;
                    ...
                    ux2 = + poSrcGrid[PO_INDEX(x, y, z-2)]._E  - poSrcGrid[PO_INDEX(x, y, z-2)]._W
                          + poSrcGrid[PO_INDEX(x, y, z-2)]._NE - poSrcGrid[PO_INDEX(x, y, z-2)]._NW
                          + poSrcGrid[PO_INDEX(x, y, z-2)]._SE - poSrcGrid[PO_INDEX(x, y, z-2)]._SW
                          + poSrcGrid[PO_INDEX(x, y, z-2)]._ET + poSrcGrid[PO_INDEX(x, y, z-2)]._EB
                          - poSrcGrid[PO_INDEX(x, y, z-2)]._WT - poSrcGrid[PO_INDEX(x, y, z-2)]._WB;
                    
                    uy2 = + poSrcGrid[PO_INDEX(x, y, z-2)]._N  - poSrcGrid[PO_INDEX(x, y, z-2)]._S
                          + poSrcGrid[PO_INDEX(x, y, z-2)]._NE + poSrcGrid[PO_INDEX(x, y, z-2)]._NW
                          - poSrcGrid[PO_INDEX(x, y, z-2)]._SE - poSrcGrid[PO_INDEX(x, y, z-2)]._SW
                          + poSrcGrid[PO_INDEX(x, y, z-2)]._NT + poSrcGrid[PO_INDEX(x, y, z-2)]._NB
                          - poSrcGrid[PO_INDEX(x, y, z-2)]._ST - poSrcGrid[PO_INDEX(x, y, z-2)]._SB;
                    
                    uz2 = + poSrcGrid[PO_INDEX(x, y, z-2)]._T  - poSrcGrid[PO_INDEX(x, y, z-2)]._B
                          + poSrcGrid[PO_INDEX(x, y, z-2)]._NT - poSrcGrid[PO_INDEX(x, y, z-2)]._NB
                          + poSrcGrid[PO_INDEX(x, y, z-2)]._ST - poSrcGrid[PO_INDEX(x, y, z-2)]._SB
                          + poSrcGrid[PO_INDEX(x, y, z-2)]._ET - poSrcGrid[PO_INDEX(x, y, z-2)]._EB
                          + poSrcGrid[PO_INDEX(x, y, z-2)]._WT - poSrcGrid[PO_INDEX(x, y, z-2)]._WB;
...
void PO_performStreamCollide(PoCellEntry* poSrcGrid, PoCellEntry* poDstGrid)
{    
    MY_TYPE ux, uy, uz, u2, rho;
    ...
    for (z = 0; z < SIZE_Z; z++)
    {
        for (y = 0; y < SIZE_Y; y++)
        {
            for (x = 0; x < SIZE_X; x++)
            {
                const MY_TYPE src_c =  PO_SRC_C  ( poSrcGrid );
                const MY_TYPE src_n =  PO_SRC_N  ( poSrcGrid );
                const MY_TYPE src_s =  PO_SRC_S  ( poSrcGrid );
                const MY_TYPE src_e =  PO_SRC_E  ( poSrcGrid );
                const MY_TYPE src_w =  PO_SRC_W  ( poSrcGrid );
                const MY_TYPE src_t =  PO_SRC_T  ( poSrcGrid );
                const MY_TYPE src_b =  PO_SRC_B  ( poSrcGrid );
                const MY_TYPE src_ne = PO_SRC_NE ( poSrcGrid );
                const MY_TYPE src_nw = PO_SRC_NW ( poSrcGrid );
                const MY_TYPE src_se = PO_SRC_SE ( poSrcGrid );
                const MY_TYPE src_sw = PO_SRC_SW ( poSrcGrid );
                const MY_TYPE src_nt = PO_SRC_NT ( poSrcGrid );
                const MY_TYPE src_nb = PO_SRC_NB ( poSrcGrid );
                const MY_TYPE src_st = PO_SRC_ST ( poSrcGrid );
                const MY_TYPE src_sb = PO_SRC_SB ( poSrcGrid );
                const MY_TYPE src_et = PO_SRC_ET ( poSrcGrid );
                const MY_TYPE src_eb = PO_SRC_EB ( poSrcGrid );
                const MY_TYPE src_wt = PO_SRC_WT ( poSrcGrid );
                const MY_TYPE src_wb = PO_SRC_WB ( poSrcGrid );

                MY_TYPE* dst_c  = &PO_DST_C  (poDstGrid);
                MY_TYPE* dst_n  = &PO_DST_N  (poDstGrid);
                MY_TYPE* dst_s  = &PO_DST_S  (poDstGrid);
                MY_TYPE* dst_e  = &PO_DST_E  (poDstGrid);
                MY_TYPE* dst_w  = &PO_DST_W  (poDstGrid);
                MY_TYPE* dst_t  = &PO_DST_T  (poDstGrid);
                MY_TYPE* dst_b  = &PO_DST_B  (poDstGrid);
                MY_TYPE* dst_ne = &PO_DST_NE  (poDstGrid);
                MY_TYPE* dst_nw = &PO_DST_NW  (poDstGrid);
                MY_TYPE* dst_se = &PO_DST_SE  (poDstGrid);
                MY_TYPE* dst_sw = &PO_DST_SW  (poDstGrid);
                MY_TYPE* dst_nt = &PO_DST_NT  (poDstGrid);
                MY_TYPE* dst_nb = &PO_DST_NB  (poDstGrid);
                MY_TYPE* dst_st = &PO_DST_ST  (poDstGrid);
                MY_TYPE* dst_sb = &PO_DST_SB  (poDstGrid);
                MY_TYPE* dst_et = &PO_DST_ET  (poDstGrid);
                MY_TYPE* dst_eb = &PO_DST_EB  (poDstGrid);
                MY_TYPE* dst_wt = &PO_DST_WT  (poDstGrid);
                MY_TYPE* dst_wb = &PO_DST_WB  (poDstGrid);

                if( PO_TEST_FLAG_SWEEP( poSrcGrid, OBSTACLE )) {
                    *dst_c  = src_c;
                    *dst_s  = src_n;
                    *dst_n  = src_s;
                    *dst_w  = src_e;
                ...
                if( PO_TEST_FLAG_SWEEP( poSrcGrid, ACCEL )) {
                    ux = 0.005;
                    uy = 0.002;
                    uz = 0.000;
                }
