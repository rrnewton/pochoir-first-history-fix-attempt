...
static void CopyLbmGridToPochoirGrid(LBM_Grid lbmGrid, T_Array& parr, const int t)
{
    for (int z=0; z<SIZE_Z; z++)
    {
        ...
        for (int y=0; y<SIZE_Y; y++)
        {
            for (int x=0; x<SIZE_X; x++)
            {
                ...
                parr(t, new_z, y, x)._C  =  LOCAL(lbmGrid, C);
                parr(t, new_z, y, x)._N  =  LOCAL(lbmGrid, N);
                parr(t, new_z, y, x)._S  =  LOCAL(lbmGrid, S);
                parr(t, new_z, y, x)._E  =  LOCAL(lbmGrid, E);
                parr(t, new_z, y, x)._W  =  LOCAL(lbmGrid, W);
                parr(t, new_z, y, x)._T  =  LOCAL(lbmGrid, T);
                parr(t, new_z, y, x)._B  =  LOCAL(lbmGrid, B);
                parr(t, new_z, y, x)._NE =  LOCAL(lbmGrid, NE);
                parr(t, new_z, y, x)._NW =  LOCAL(lbmGrid, NW);
                parr(t, new_z, y, x)._SE =  LOCAL(lbmGrid, SE);
                parr(t, new_z, y, x)._SW =  LOCAL(lbmGrid, SW);
                parr(t, new_z, y, x)._NT =  LOCAL(lbmGrid, NT);
                parr(t, new_z, y, x)._NB =  LOCAL(lbmGrid, NB);
                parr(t, new_z, y, x)._ST =  LOCAL(lbmGrid, ST);
                parr(t, new_z, y, x)._SB =  LOCAL(lbmGrid, SB);
                parr(t, new_z, y, x)._ET =  LOCAL(lbmGrid, ET);
                parr(t, new_z, y, x)._EB =  LOCAL(lbmGrid, EB);
                parr(t, new_z, y, x)._WT =  LOCAL(lbmGrid, WT);
                parr(t, new_z, y, x)._WB =  LOCAL(lbmGrid, WB);
                parr(t, new_z, y, x)._FLAGS =  LOCAL(lbmGrid, FLAGS);
            }
        }
    }    
}

static void CopyPochoirGridToLbmGrid(LBM_Grid lbmGrid, T_Array& parr, const int t)
{
for (int z=0; z<SIZE_Z; z++)
    {
        const int new_z = z + MARGIN_Z;
        for (int y=0; y<SIZE_Y; y++)
        {
            ...
            {
                const int i = CALC_INDEX(x, y, z, 0);
                LOCAL(lbmGrid, C)  = parr(t, new_z, y, x)._C;
                LOCAL(lbmGrid, N)  = parr(t, new_z, y, x)._N;
                LOCAL(lbmGrid, S)  = parr(t, new_z, y, x)._S;
                LOCAL(lbmGrid, E)  = parr(t, new_z, y, x)._E;
                LOCAL(lbmGrid, W)  = parr(t, new_z, y, x)._W;
                LOCAL(lbmGrid, T)  = parr(t, new_z, y, x)._T;
                LOCAL(lbmGrid, B)  = parr(t, new_z, y, x)._B;                
                LOCAL(lbmGrid, NE) = parr(t, new_z, y, x)._NE;
                LOCAL(lbmGrid, NW) = parr(t, new_z, y, x)._NW;
                LOCAL(lbmGrid, SE) = parr(t, new_z, y, x)._SE;
                LOCAL(lbmGrid, SW) = parr(t, new_z, y, x)._SW;
                LOCAL(lbmGrid, NT) = parr(t, new_z, y, x)._NT;
                LOCAL(lbmGrid, NB) = parr(t, new_z, y, x)._NB;
                LOCAL(lbmGrid, ST) = parr(t, new_z, y, x)._ST;
                LOCAL(lbmGrid, SB) = parr(t, new_z, y, x)._SB;
                LOCAL(lbmGrid, ET) = parr(t, new_z, y, x)._ET;
                LOCAL(lbmGrid, EB) = parr(t, new_z, y, x)._EB;
                LOCAL(lbmGrid, WT) = parr(t, new_z, y, x)._WT;
                LOCAL(lbmGrid, WB) = parr(t, new_z, y, x)._WB;
                LOCAL(lbmGrid, FLAGS) = parr(t, new_z, y, x)._FLAGS;
            }
        }
    }    
}
...
void InitPochoir(MAIN_SimType simtype, LBM_Grid srcGrid, LBM_Grid dstGrid)
{
    mySimType = simtype;
...
void RunPochoir(int numTimeSteps)
{
    /*
...
void FinishPochoir(LBM_Grid srcGrid, LBM_Grid dstGrid)
{
